              ...
              <tr>
                ...
                <td>
                  <form action="{{ route('category.destroy', $data->id) }}" method="POST">
                    @csrf
                    @method('delete')
                    <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-circle btn-edit"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-title">Tambah Category</h5>
...
@section('script')
  ...
  <script>
    ...
    $(".btn-add").click(function(){
      ...
      $("#id").val("");
      $("#name").val("");
      $("#form-category").attr("action", "{{ route('category.store') }}");
      $("#form-category").find("input[name='_method']").remove();
    });
    ...
    $("#dataTable").on("click", ".btn-edit", function () {
      ...
      $("#form-category").attr("action", "/category/" + id);
      $("#form-category").append('<input type="hidden" name="_method" value="PUT">');
    });
